...
public class JanelaConsultarExcluirPlacaCarga  implements ActionListener{
	...
	public JanelaConsultarExcluirPlacaCarga() {

	}

	@Override
	public void actionPerformed(ActionEvent e) {
		janelaExcluirPlacaVeiculosCarga();
	}

	public void janelaExcluirPlacaVeiculosCarga() {
		...
		btnConsultar.addActionListener(new BotaoConsultarPlacaCarga(jan1, textField1, textField2, textField3, textField4, textField5, textField6, textField7, textField8, textField9, textFieldExtra));
		btnExcluir.addActionListener(new BotaoExcluirPlacaCarga(jan1, textField2));
